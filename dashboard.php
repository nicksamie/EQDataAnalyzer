...
<?php 
    if (empty($_POST["chosen_district"])) {
        $chosen_district = "kathmandu";
      } else {
        $chosen_district = $_POST['chosen_district'];
    }
?>
    <!-- mySQL Connection -->
 <?php
        require_once('mysqlconnection.php'); 
        $query = "SELECT district,total_no_houses,total_popn,injured,
                  dead_male, dead_female from eqreport2015 where district = '$chosen_district'";
        $result = connect_mysql($query);
         while($row = mysqli_fetch_assoc($result)) {
            $district =  $row["district"];
             $total_no_houses = $row["total_no_houses"];
             $total_popn = $row["total_popn"];
             $injured = $row["injured"];
             $death = $row["dead_male"] + $row["dead_female"];
        }
        //$data = mysqli_fetch_assoc($result)
        //$data = mysql_fetch_row($result);
        //echo $data["total_no_houses"];
?>
 <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                     <h2>Dashboard</h2>   
                        <h5>Information of : <h1><?php echo $district ?> </h1></h5>
                    </div>
                </div>              
                 <!-- /. ROW  -->
                  <hr />
            ...
            <div class="panel panel-back noti-box">
              <div class="tet-box" >
              <p class="text-muted">Total No. of Houses</p>
                <p class="main-text"><?php echo $total_no_houses?></p>
            ...
            <div class="panel panel-back noti-box">
              <div class="text-box" >
               <p class="text-muted">Total Population</p>
                <p class="main-text"><?php echo $total_popn?></p>
            ...
            <div class="panel panel-back noti-box">
              <div class="text-box" >
               <p class="text-muted">Injured</p>
                <p class="main-text"><?php echo $injured ?></p>
            ...
            <div class="panel panel-back noti-box">
              <div class="text-box" >
               <p class="text-muted">Total Death</p>
                <p class="main-text"><?php echo $death?></p>
